            ...
            <div className="overflow-hidden rounded-md bg-gray-50 p-2 md:pt-0">
              ...
              <div className="md:hidden">
                {Array.from({ length: 3 }).map((_, index) => (
                  <div key={index} className="mb-2 w-full rounded-md bg-white p-4 animate-pulse">
                    ...
                    <div className="flex w-full items-center justify-between border-b py-5">
                      <div className="flex w-1/2 flex-col">
                        ...
                        <div className="h-4 w-14 bg-gray-300 rounded mt-1"></div>
                      </div>
                      <div className="flex w-1/2 flex-col">
                        <div className="h-3 w-10 bg-gray-300 rounded"></div>
                        <div className="h-4 w-14 bg-gray-300 rounded mt-1"></div>
              ...
              <table className="hidden min-w-full rounded-md text-gray-900 md:table">
                ...
                <tbody className="divide-y divide-gray-200 text-gray-900">
                  {Array.from({ length: 5 }).map((_, index) => (
                    <tr key={index} className="group animate-pulse">
